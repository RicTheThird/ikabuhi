    ...
    <Box sx={{ padding: 4, backgroundColor: '#f8f4f4', minHeight: '100vh' }}>
      <Box mb={4}>
        <Typography variant="h4" sx={{ fontWeight: 'bold' }} gutterBottom>
          {group?.name}: <Typography component="span" variant="h5">{group?.memberCount} Members</Typography>
        </Typography>
        <Typography variant="h6">BARANGAY: {group?.brgy}</Typography>
        <Typography variant="h6">DAY: {group?.meetingDay}</Typography>
        <Typography variant="h6">MEETING TIME: {group?.meetingTime}</Typography>
      </Box>
