                ...
                {step === 2 && (
                    ...
                    <CardContent>
                      ...
                      <Grid container spacing={2}>
                        <Grid item xs={12}>
                          <TextField label="Type of Project" fullWidth variant="outlined" />
                        </Grid>
                        <Grid item xs={12}>
                          <TextField
                        ...
                        <Grid item xs={12}>
                          <TextField
                            ...
                            fullWidth
                            variant="outlined"
                            disabled={false} // Set to true/false based on collateral selection
                          />
                        </Grid>
                      </Grid>
                      <Divider sx={{ my: 2 }} />
                      <Box>
                        <FormControlLabel
                          ...
                          label={
                            <Typography variant="body2">
                              I, (Full Name), declare that all the information provided in this
